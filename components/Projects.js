let Projects = [
    {
        titulo: "Projeto matrícula digital",
        img: "./assets/matricula-digital-img.png",
        text1: "<h4>Modernizando o Processo de Matrículas Escolares:</h4><br> Rumo a uma Inscrição Digital Como sabemos, o processo de matrícula escolar pode ser um momento desafiador, muitas vezes marcado por longas filas, papelada extensa e uma dose considerável de estresse.No entanto, estamos animados em propor uma solução que pode transformar completamente essa experiência: a transição para um sistema de matrícula digital. Ao adotar um sistema de matrícula digital, podemos eliminar as filas e tornar todo o processo mais conveniente e eficiente para todos os envolvidos.",
        text2: "Aqui estão alguns dos benefícios que a mudança para a matrícula digital pode trazer:"
        +"<p>"
            +"<ol>"
            +"<li>Conveniência: Pais e responsáveis poderão completar o processo de matrícula a qualquer momento e de qualquer lugar, sem a necessidade de visitar a escola pessoalmente.</li>"
            +"<li>Redução de Filas e Tempo de Espera: Adeus longas filas! Com a matrícula digital, não haverá mais a necessidade de esperar por horas para inscrever seu filho na escola.</li>"
            +"<li>Acesso Simplificado a Informações: Todas as informações necessárias para a matrícula estarão disponíveis online, facilitando o acesso e evitando confusões.</li>"
            +"<li>Maior Eficiência Administrativa: O processo digital pode ajudar a reduzir a carga de trabalho administrativo, permitindo que nossa equipe se concentre em outras tarefas importantes.</li>"
            +"<li>Sustentabilidade: A transição para a matrícula digital é também um passo em direção à sustentabilidade, reduzindo a necessidade de papel e outros recursos.Portanto, gostaríamos de ouvir suas opiniões e feedback sobre essa proposta.</li>"
            + "</ol>"
        +"</p>"
